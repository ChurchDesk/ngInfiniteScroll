    ...
    return {
      ...
      link: function link(scope, elem, attrs) {
        ...
        function height(element, includeChildren) {
          var targetElement = element[0] || element;
          if (includeChildren === true) {
            var totalHeight = 0;
            _angular2['default'].forEach(_angular2['default'].element(targetElement).children(), function (child) {
              totalHeight += _angular2['default'].element(child).height();
            });
            return totalHeight;
